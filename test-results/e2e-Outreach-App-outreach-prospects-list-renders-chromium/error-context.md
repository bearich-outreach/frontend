...
- Name: e2e.spec.ts >> Outreach App >> outreach prospects list renders
...
Locator: getByText('Prospects')
Expected: visible
Error: strict mode violation: getByText('Prospects') resolved to 2 elements:
    1) <a class="nav-link-active" href="/apps/outreach/prospects">…</a> aka getByRole('link', { name: 'Prospects' })
    2) <a href="/apps/outreach/prospects" class="nav-link-active shrink-0">Prospects</a> aka locator('header').getByText('Prospects')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Prospects')
  ...
  - generic [ref=e12]:
    ...
    - main [ref=e41]:
      - generic [ref=e42]:
        - generic [ref=e43]:
          - generic [ref=e44]:
            - heading "Prospects" [level=1] [ref=e45]
            - paragraph [ref=e46]: 0 prospek dalam pipeline.
          - generic [ref=e47]:
            - link "Export CSV" [ref=e48] [cursor=pointer]:
              - /url: http://localhost:4000/api/apps/outreach/prospects/export
            - link "+ Tambah" [ref=e49] [cursor=pointer]:
              - /url: /apps/outreach/prospects/new
        - table [ref=e51]:
          - rowgroup [ref=e52]:
            - row [ref=e53]:
              - columnheader "Nama" [ref=e54]
              - columnheader "Perusahaan" [ref=e55]
              - columnheader "Kanal" [ref=e56]
              - columnheader "Status" [ref=e57]
              - columnheader "Step" [ref=e58]
              - columnheader "Follow-up berikut" [ref=e59]
          - rowgroup [ref=e60]:
            - row [ref=e61]:
              - cell [ref=e62]:
                - text: Belum ada prospek. Mulai dari
                - link "tambah prospek" [ref=e63] [cursor=pointer]:
                  - /url: /apps/outreach/prospects/new
                - text: .
```
