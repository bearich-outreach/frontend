...
- Name: e2e.spec.ts >> Cashflow App >> cashflow transactions page has date range filter
- Location: tests/e2e.spec.ts:199:7
...
Locator: getByText('Transaksi')
Expected: visible
Error: strict mode violation: getByText('Transaksi') resolved to 7 elements:
    1) <a class="nav-link-active" href="/apps/cashflow/transactions">…</a> aka getByRole('link', { name: 'Transaksi', exact: true })
    2) <a class="nav-link" href="/apps/cashflow/transactions/new">…</a> aka getByRole('navigation').getByRole('link', { name: '+ Catat Transaksi' })
    3) <a class="nav-link-active shrink-0" href="/apps/cashflow/transactions">Transaksi</a> aka locator('header').getByText('Transaksi', { exact: true })
    4) <a class="nav-link shrink-0" href="/apps/cashflow/transactions/new">+ Catat Transaksi</a> aka locator('header').getByText('+ Catat Transaksi')
    5) <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Transaksi</h1> aka getByRole('heading', { name: 'Transaksi' })
    6) <p class="text-sm text-zinc-500">0 transaksi.</p> aka getByText('transaksi.')
    7) <a class="btn-primary" href="/apps/cashflow/transactions/new">+ Catat Transaksi</a> aka getByRole('main').getByRole('link', { name: '+ Catat Transaksi' })

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Transaksi')
  ...
  - generic [ref=e12]:
    ...
    - main [ref=e44]:
      - generic [ref=e45]:
        - generic [ref=e46]:
          - generic [ref=e47]:
            - heading "Transaksi" [level=1] [ref=e48]
            - paragraph [ref=e49]: 2 transaksi.
          - link "+ Catat Transaksi" [ref=e50] [cursor=pointer]:
            - /url: /apps/cashflow/transactions/new
        - generic [ref=e51]:
          - textbox [ref=e52]
          - generic [ref=e53]: s/d
          ...
          - combobox [ref=e56]:
            ...
            - option "Lainnya"
          - combobox [ref=e57]:
            - option "Semua akun" [selected]
            - option "Tunai"
            - option "Rekening"
            - option "E-Wallet"
          - generic [ref=e58]: "Total: Rp 4.500.000"
        - table [ref=e60]:
          - rowgroup [ref=e61]:
            - row [ref=e62]:
              - columnheader "Tanggal" [ref=e63]
              - columnheader "Tipe" [ref=e64]
              - columnheader "Akun" [ref=e65]
              - columnheader "Kategori" [ref=e66]
              - columnheader "Keterangan" [ref=e67]
              - columnheader "Nominal" [ref=e68]
              - columnheader "Aksi" [ref=e69]
          - rowgroup [ref=e70]:
            - row [ref=e71]:
              - cell "31 Agu 2026" [ref=e72]
              - cell "Masuk" [ref=e73]
              - cell "Rekening" [ref=e75]
              - cell "Gaji" [ref=e76]
              - cell "Gaji bulanan" [ref=e77]
              - cell "+ Rp 5.000.000" [ref=e78]
              - cell [ref=e79]:
                - generic [ref=e80]:
                  - button "Edit" [ref=e81] [cursor=pointer]
                  - button "Hapus" [ref=e82] [cursor=pointer]
            - row [ref=e83]:
              - cell "30 Agu 2026" [ref=e84]
              - cell "Keluar" [ref=e85]
              - cell "Tunai" [ref=e87]
              - cell "Makanan" [ref=e88]
              - cell "Belanja" [ref=e89]
              - cell "− Rp 500.000" [ref=e90]
              - cell [ref=e91]:
                - generic [ref=e92]:
                  - button "Edit" [ref=e93] [cursor=pointer]
                  - button "Hapus" [ref=e94] [cursor=pointer]
```
