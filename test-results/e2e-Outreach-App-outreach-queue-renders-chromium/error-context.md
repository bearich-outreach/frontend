...
- Name: e2e.spec.ts >> Outreach App >> outreach queue renders
...
Locator: getByText('Outreach Queue')
Expected: visible
Error: strict mode violation: getByText('Outreach Queue') resolved to 2 elements:
    1) <a class="nav-link-active" href="/apps/outreach/queue">…</a> aka getByRole('link', { name: 'Outreach Queue' })
    2) <a href="/apps/outreach/queue" class="nav-link-active shrink-0">Outreach Queue</a> aka locator('header').getByText('Outreach Queue')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Outreach Queue')
  ...
  - generic [ref=e12]:
    ...
    - main [ref=e41]:
      - generic [ref=e42]:
        - generic [ref=e43]:
          - generic [ref=e44]:
            - heading "Outreach Queue" [level=1] [ref=e45]
            - paragraph [ref=e46]: 0 prospek yang perlu dihubungi hari ini. Kerjakan satu per satu dengan konsisten — hasilnya pasti secara statistik.
          - button "Refresh" [ref=e47] [cursor=pointer]
        - generic [ref=e48]: Tidak ada yang perlu di-outreach sekarang. Tambah prospek baru atau tunggu jadwal follow-up berikutnya.
```
