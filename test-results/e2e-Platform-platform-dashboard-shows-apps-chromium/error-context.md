...
- Name: e2e.spec.ts >> Platform >> platform dashboard shows apps
...
Locator: getByText('Aplikasi')
Expected: visible
Error: strict mode violation: getByText('Aplikasi') resolved to 2 elements:
    1) <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Aplikasi</h1> aka getByRole('heading', { name: 'Aplikasi' })
    2) <p class="text-sm text-zinc-500">Pilih aplikasi untuk dibuka.</p> aka getByText('Pilih aplikasi untuk dibuka.')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Aplikasi')
  ...
  - generic [ref=e2]:
    - banner [ref=e3]:
      - generic [ref=e4]:
        - generic [ref=e5]:
          - generic [ref=e6]: B
          - generic [ref=e7]: Bearich Hub
          - generic [ref=e8]: Hub
        - generic [ref=e9]:
          - button "Toggle tema" [ref=e10] [cursor=pointer]
          - button "Keluar" [ref=e13] [cursor=pointer]
    - main [ref=e14]:
      - generic [ref=e15]:
        - generic [ref=e16]:
          - heading "Aplikasi" [level=1] [ref=e17]
          - paragraph [ref=e18]: Pilih aplikasi untuk dibuka.
        - generic [ref=e19]:
          - link "O Outreach Pipeline & otomasi outreach" [ref=e20] [cursor=pointer]:
            - /url: /apps/outreach
            - generic [ref=e21]: O
            - heading "Outreach" [level=3] [ref=e25]
            - paragraph [ref=e26]: Pipeline & otomasi outreach
          - link "T Task Management Kelola tugas harian" [ref=e27] [cursor=pointer]:
            - /url: /apps/tasks
            - generic [ref=e28]: T
            - heading "Task Management" [level=3] [ref=e32]
            - paragraph [ref=e33]: Kelola tugas harian
          - link "N Notes Catatan & dokumentasi" [ref=e34] [cursor=pointer]:
            - /url: /apps/notes
            - generic [ref=e35]: "N"
            - heading "Notes" [level=3] [ref=e39]
            - paragraph [ref=e40]: Catatan & dokumentasi
          - link "C Cash Flow Catat uang masuk & keluar" [ref=e41] [cursor=pointer]:
            - /url: /apps/cashflow
            - generic [ref=e42]: C
            - heading "Cash Flow" [level=3] [ref=e46]
            - paragraph [ref=e47]: Catat uang masuk & keluar
