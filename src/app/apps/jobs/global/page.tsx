...
export default function JobsGlobalPage() {
  ...
  // Jabaran skor: tutup otomatis saat ganti tab/halaman.
  useEffect(() => { setOpenId(null); }, [tab, page]);
